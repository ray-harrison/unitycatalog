...
- **Admin bootstrap** - Automatically grant admin privileges to specified users on first authentication. See [Admin Bootstrap](docs/server/auth.md#admin-bootstrap-via-email-allowlist) for configuration details.
